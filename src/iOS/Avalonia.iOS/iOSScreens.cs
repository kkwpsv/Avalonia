...
internal class iOSScreen(UIScreen screen) : Screen(new UIScreenPlatformHandle(screen))
{
    public void Refresh()
    {
...
internal class iOSScreens : ScreensBaseImpl<UIScreen, iOSScreen>
{
    public iOSScreens()
    {
    ...
    protected override void RefreshScreen(iOSScreen screen) => screen.Refresh();

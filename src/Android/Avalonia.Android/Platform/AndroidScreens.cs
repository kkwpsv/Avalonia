...
internal class AndroidScreen(Display display) : Screen(new PlatformHandle(new IntPtr(display.DisplayId), "DisplayId"))
{
...
internal sealed class AndroidScreens : ScreensBaseImpl<Display, AndroidScreen>, IDisposable
{
    ...
    protected override void RefreshScreen(AndroidScreen screen) => screen.Refresh(_context);

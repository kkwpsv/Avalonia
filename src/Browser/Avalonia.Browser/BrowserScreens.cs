...
internal sealed class BrowserScreen(JSObject screen) : Screen(new JSObjectPlatformHandle(screen))
{
...
internal sealed class BrowserScreens : ScreensBaseImpl<JSObject, BrowserScreen>
{
    ...
    protected override void RefreshScreen(BrowserScreen screen) => screen.Refresh();
